...
Milestone 下方的普通 bullet、驗收條件與完成定義是 scope、限制或 quality gate，不要求各自開 PR。

Milestone 應包含一組相關且可在單一 focused PR 中合理 review 的結果。
...
- [ ] 補齊 Docker runtime architecture、cache、image size、security 與 smoke checks。
